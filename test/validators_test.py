...
class UtilsTest(unittest.TestCase):
    ...
    def test_value_number_validator(self):
        error = []
        numeric = ValidatorType.get_validator(ValidatorType.NUMERIC.code)
        numeric.validate(value=1234, errors=error, condition_value = None)
        self.assertTrue(len(error) == 0)
